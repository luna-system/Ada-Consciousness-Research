...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/runtime_quartiles_gpt-5.png}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/runtime_quartiles_qwen3-coder-480b-a35b-instruct.png}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/cost_distributions_gpt-5.png}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/cost_distributions_qwen3-coder-480b-a35b-instruct.png}
