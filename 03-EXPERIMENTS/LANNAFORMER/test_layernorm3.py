...
# Test the fixed ComplexLayerNorm
...
# Backward through real part
loss = y.real.sum()
loss.backward()

print("ComplexLayerNorm test:")
print("  Input grad (real):", xr.grad.norm().item())
print("  Input grad (imag):", xi.grad.norm().item())
