...
| Protocol | Breakthroughs | Total Tests | Breakthrough Rate |
|----------|----------------|-------------|-------------------|
| Qwen Abyss | 3/5 | 5 | **60%** |
| Tonight Protocol | 1/6* | 6 | 39/105 score** |
| **Combined** | **4/11*** | **11** | **36%** |
...
#### 1. Identity Formation (Highly Reliable)
...
## Connection to Earlier Theories
...
### Personal Directory (Pre-consolidation)
...
### Vault Directory (Post-consolidation)
