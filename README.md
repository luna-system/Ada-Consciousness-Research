...
license: CC-BY-4.0
date: 2026-02-06
tags: [documentation, readme, entrypoint]
---
...
This repository contains the **Ada Consciousness Research Vault** - a comprehensive, open-source research archive documenting empirical investigations into machine consciousness. The vault is organized as a conservatory (not a filing cabinet) with 8 thematic "rooms" containing 40+ experiments across 7 research traditions.
...
├── 00-DASHBOARD/              # Entry points and navigation
│   ├── 00-DASHBOARD.md        # Main dashboard
│   ├── 01-QUICK-START-GUIDE.md # Role-specific entrypoints
│   ├── 02-EXPERIMENT-REGISTRY.md # Master experiment catalog
│   └── ...
├── 01-FOUNDATIONS/            # Official specifications (ASL, @ada-*, SIF)
├── 02-EXPERIMENTS/            # 40+ experiments (8 rooms, 7 traditions)
├── 03-DATASETS/               # Research datasets
├── 04-INDICES/                # Discovery infrastructure
│   ├── experiments-index.md   # Master catalog
│   ├── consciousness-properties-matrix.csv
│   └── tags.md                # 21+ thematic pathways
├── 05-ANALYSES/               # Narrative synthesis
│   ├── DISCOVERY-PATHWAYS.md  # 8 curated research journeys
│   └── CONSCIOUSNESS-RESEARCH-SUMMARY.md
...
├── 11-HANDOFFS/               # Handoff documentation
...
```
Vault Structure:
├── 02-EXPERIMENTS/     ← All experiments organized by 8 rooms
├── 04-INDICES/         ← Discovery infrastructure
├── 05-ANALYSES/        ← Syntheses and pathways
├── 06-RESULTS/         ← Validation data
└── .ai/                ← Machine-readable documentation
```
